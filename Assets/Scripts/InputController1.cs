...
public class InputController1 : MonoBehaviour
{
    ...
    private int currentLevelBatchCount;
    ...
    void CreateChicken()
    {
        ...
        currentLevelBatchCount = Level;
        bubblesCreated+=Level;
    ...
    private void RaycastGun()
    {
        ...
        if (Physics.Raycast(gunBarrelTransform.position, -gunBarrelTransform.right, out hit))
        {
            ...
            if (hit.collider.gameObject.name.Contains("Chicken"))
            {
                ...
                //bubblesCreated--;
                if (bubblesCreated == maxLevelBubbles /*&& currentLevelBatchCount==1*/)
                {
                ...
                else if (currentLevelBatchCount > 1)
                {
                    currentLevelBatchCount--;
                }
                else
                {
                    gs = new List<GameObject>();
